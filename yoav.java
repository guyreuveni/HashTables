...
public class yoav {
    public static void main(String[] args) throws IHashTable.KeyDoesntExistException,
        ...
        LPHashTable lpht = new LPHashTable(10000019, 1000000007);
        QPHashTable qpht = new QPHashTable(10000019, 1000000007);
        AQPHashTable aqpht = new AQPHashTable(10000019, 1000000007);
        DoubleHashTable dht = new DoubleHashTable(10000019, 1000000007);
        ...
        System.out.println(String.format("LPHashTable total runtime in seconds: %s", lphtTime / Math.pow(10, 9)));
        System.out.println(String.format("QPHashTable total runtime in seconds: %s", qphtTime / Math.pow(10, 9)));
        System.out.println(String.format("AQPHashTable total runtime in seconds: %s", aqphtTime / Math.pow(10, 9)));
        System.out.println(String.format("DoubleHashTable total runtime in seconds: %s", dhtTime / Math.pow(10, 9)));
        ...
        System.out.println(String.format("First three iterations total runtime in seconds: %s",
                firstThreeIterTime / Math.pow(10, 9)));
        System.out.println(String.format("Last three iterations total runtime in seconds: %s",
                lastThreeIterTime / Math.pow(10, 9)));
